...
class FoodMap: 
    ...
    def _find_current_robot_loc(self): 
        ...
        self.current_robot_loc = temp_current_robot_loc[0][0], temp_current_robot_loc[1][0]
    ...
    def _get_updown_coords(self, loc: tuple, direction: np.array, food_map: np.array) -> list: 
    ...
    def _get_updown_coords_from_list(self, locs: list[tuple], direction: np.array, food_map: np.array) -> list: 
    ...
    def move_part2(self, inst: str, use_old_method: bool = False, iteration=int): 
        ...
        next_coords_to_check = self._get_updown_coords_from_list(old_locations[-1], direction, food_map)
        next_values_to_check = self._evaluate_multiple_coords(next_coords_to_check, food_map)
    ...
    def calculate_location_score(self): 
        ...
        score = 0
        for row_box_location, column_box_location in zip(box_locations[0], box_locations[1]): 
