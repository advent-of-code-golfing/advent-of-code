...
def _get_all_possible_values_recursive(x_s: list): 
    if len(x_s) == 2: 
        ...
        return _get_all_possible_values_recursive([x_s[0]*x_s[1]] + x_s[2:]) + _get_all_possible_values_recursive([x_s[0]+x_s[1]] + x_s[2:])
...
def _get_all_possible_values_recursive_part2(x_s: list): 
    if len(x_s) == 2: 
        ...
        op_3 = _get_all_possible_values_recursive_part2([_concatenate(x_s[0], x_s[1])] + x_s[2:])
