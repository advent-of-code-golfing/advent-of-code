...
class ComputerMaze: 
    ...
    def check_for_cheats(self, coord: tuple, maze: np.array, known_coords: list, starting_path_length: int): 
        for direction in DIRECTIONS: 
            ...
            if not (maze[one_point_out] == 1 and maze[two_point_out] == 0) and not (maze[one_point_out] == 1 and maze[two_point_out] == 9): 
                continue 
    ...
    def check_for_cheats_multi_len(self, coord: tuple, maze: np.array, known_coords_dict: dict, starting_path_length: int, cheat_len: int = 20, part_1 = True): 
        if coord == (1,1): 
            print('hello')
    ...
    def find_shortest_path(self, 
        ...
        while self.end_loc not in old_known_coords: 
            ...
            for coord in old_known_coords: 
                if num_cheats > 0: 
                    self.check_for_cheats_multi_len(coord=coord, 
                                          maze=maze, 
...
def q2(cm: ComputerMaze) -> int: 
    ...
    _, shortest_path = cm.find_shortest_path(num_cheats=1, starting_path_length=0, cheat_len = 20, part_1=False)
