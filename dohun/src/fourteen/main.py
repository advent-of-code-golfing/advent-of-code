...
def q1(initial_locations: list, velocities: list, len_rows: int, len_cols: int, iterations: int = 100) -> int:
    ...
    product = 1
    for quadrant in [top_left_quadrant, top_right_quadrant, bottom_left_quadrant, bottom_right_quadrant]:
